...
function breakInfo = breakxaxis(varargin)
    ...
    xPoints1 = amp *theta+ mainPosition(1) + leftWidthTemp
    xPoints2 = amp *theta+ mainPosition(1) + mainPosition(3) - rightWidthTemp
    
    patchPointsX = [xPoints1 xPoints2(end:-1:1) xPoints1(1)];
    patchPointsY = [yPoints  yPoints(end:-1:1)  yPoints(1)];
    patch(patchPointsX,patchPointsY ,figureColor,'EdgeColor','w','Parent',breakAxes);
