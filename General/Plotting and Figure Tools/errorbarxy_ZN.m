function [varargout]=errorbarxy_ZN(varargin)
...
if strcmp(color{1},'.')
    MarkerSize=MarkerSizePoint;
elseif strcmp(color{1},'o')
    MarkerSize=MarkerSizeCircle;
else
...
h=plot(x,y, color{1},'MarkerSize',MarkerSize); % main plot
