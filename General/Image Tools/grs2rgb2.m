function res = grs2rgb2(img, map)
%Zach edited version of grs2rgb to fix color size issues with large images
%grs2rgb2 ONLY MAKES SINGLE PRECISION COLOR MAP
...
img(img==0) = 1; % Needed to produce nonzero index of the colormap matrix
