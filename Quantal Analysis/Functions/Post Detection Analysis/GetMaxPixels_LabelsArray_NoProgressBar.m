...
function ImageArray_CorrAmp_norm_InMax = GetMaxPixels_LabelsArray_NoProgressBar(ImageArray_CorrAmp_norm, ImageArray_Labels, NumMaxPixels);
...
for ImageNumber=1:LastImageNumber
    ...
    for LabelIndex=FirstLabelNum:LastLabelNum     
        ...
        OneImage_OneResponse = OneImage_CorrAmp_norm .* OneImage_OneLabel_Mask;
