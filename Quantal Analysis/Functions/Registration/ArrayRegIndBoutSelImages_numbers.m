...
function ImageArrayReg_NoStim = ArrayRegIndBoutSelImages_numbers(ImageArray_NoStim, GoodImages_NoStim, BoutonArray, DeltaXY_ImageNumbers, DeltaX_First, DeltaY_First)
...
for Vector_Index=1:Vector_Length
    ...
    for BoutonNumber=1:LastBoutonNumber
        ...
        for ImageNumber=1:LastImageNumber
            ImageArray_Tmp(:,:,ImageNumber) = ImageArray_Tmp(:,:,ImageNumber) .* BoutonArea; % multiplying by BoutonArea
        end
